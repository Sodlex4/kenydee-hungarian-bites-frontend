            ...
            <div className="space-y-8">
              <div className="glass-card p-8">
                ...
                <p className="text-lg leading-relaxed mb-6" style={{ color: 'hsl(var(--muted-foreground))' }}>
                  Took a Hungarian family recipe, brought it to Murang'a, and gave it our own heat.
                  No shortcuts, no funny business — just straight fire.
                </p>
                <p className="text-lg leading-relaxed" style={{ color: 'hsl(var(--muted-foreground))' }}>
                  Crispy outside, tender inside, packed with flavor. Simple recipe, big taste.
                </p>
              </div>
              ...
              <div className="glass-card-accent p-8">
                ...
                <p className="text-lg leading-relaxed" style={{ color: 'hsl(var(--muted-foreground))' }}>
                  Good food, fair price, delivered fast. Every corner of Kenya deserves a bite that slaps.
                </p>
              </div>
            </div>
            ...
            {[
              ...
              <div key={index} className="stat-card text-center group">
                <div className="glass-card p-8 hover:scale-105 transition-all duration-300">
                  ...
                  <div className="text-4xl font-bold mb-2 text-gradient-primary">
                    {stat.number}
                  </div>
